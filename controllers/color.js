            ...
            if(getAllColors)
            {
                if(req.params.colorId){
                    Color.findOne({_id:req.params.colorId},function(error,resColor){
                        res.render('color/list', { title: 'Color',getAllColors:getAllColors,activeClass:3,editRes:resColor});
                    });
                }else{
                    res.render('color/list', { title: 'Color',getAllColors:getAllColors,activeClass:3,editRes:false});
                }
            }
	});	
